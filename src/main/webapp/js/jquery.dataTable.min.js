...
(function (d) {
    ...
    d.fn.dataTable = function (Obj) {/*使用table绑定 注意要用使用ID*/
        ...
        function CreateTable(Object, Table, TableID, page) {
            ...
            // Object.doubleClick(data,tdc(ev));
                ...
                for (var r = 0; r < json.length; r++) {/*遍历行*/
                    ...
                    for (var c = 0; c < columns.length; c++) {/*遍历列*/
                        ...
                        if (!empty(img) && img) {/*这一列为图片列*/
                        	...
                        	// if (empty(buttonName) || buttonName == "") {
                        	//	 var	ColumnContent1='<input type="text" '+'style="'+'width:'+Object.columns[c]["width"]+';overflow-x:visible;overflow-y:visible;"'+' value='+ColumnContent+'>';
                           //      Table.find("tr").eq(r + 1).append("<td class='" + TableID + "_td' data-row='" + parseInt(r + 2) + "' title='" + ColumnTitle + "'>" + ColumnContent1 + "</td>");
                        	// }else {
                        	var s="<td id="+'td_data_'+r+"_"+c+" class='" + TableID + "_td' data-row='" + parseInt(r + 2) + "' title='" + ColumnTitle +"'>";
                        		 Table.find("tr").eq(r + 1).append(s + ColumnContent + "</td>");
						//	}
